export const home = () => {
  ...
  <div class='home' id='home-screen'>
    ...
    <img src="img/touchButton.png" alt="touch hand" class="touch-button" id="touchButton">
    <img src="img/touchButton.png" alt="touch hand" class="touch-button" id="touchButton" type='button'>
